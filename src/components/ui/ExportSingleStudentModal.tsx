...
export type ExportFormatType = 'pdf' | 'xlsx' | 'csv';

export interface SingleStudentExportFilterValues {
  format: ExportFormatType;
  month: number | null;
  year: number | null;
}

export interface ExportSingleStudentModalProps {
  visible: boolean;
  studentId: number | string;
  studentName?: string;
  isLoading?: boolean;
  onClose: () => void;
  onExport: (values: SingleStudentExportFilterValues, actionType: 'download' | 'share') => void;
}
...
const FORMAT_OPTIONS: {
  ...
  description: string;
}[] = [
    {
      ...
      description: 'Print-ready student profile, attendance & fees',
    },
    {
      id: 'xlsx',
      ...
      description: 'Structured spreadsheet of performance & records',
    },
    {
      id: 'csv',
      label: 'CSV Data File',
      ...
      description: 'Standard comma-separated table data',
    },
  ];
...
export default function ExportSingleStudentModal({
  visible,
  studentId,
  studentName,
  isLoading = false,
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-1 pr-3">
                ...
                <Text className="text-[13px] font-urbanist-medium text-secondary tracking-tight mt-0.5" numberOfLines={1}>
                  {studentName ? `Student: ${studentName}` : `Student ID: ${studentId}`}
                </Text>
              </View>
            ...
            <View className="p-3.5 rounded-[18px] bg-[#F8FAFC] border border-primary-border gap-3">
              ...
              <View className="flex-row items-center justify-between pt-1">
                ...
                <View className="flex-row items-center gap-2">
                  ...
                  <View className="min-w-[70px] py-1 px-2.5 rounded-[8px] bg-white border border-primary-border items-center justify-center">
