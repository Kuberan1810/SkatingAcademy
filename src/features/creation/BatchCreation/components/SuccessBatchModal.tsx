...
export interface SuccessBatchModalProps {
  visible: boolean;
  batchName: string;
  location: string;
  batchTime?: string;
...
export default function SuccessBatchModal({
  visible,
  batchName,
  location,
          ...
          <View className="bg-[#DCF2FF] border border-[#C6EAFF] rounded-[22px] py-5 px-5 w-full flex-row items-center justify-between mb-12">
            ...
            <View className="flex-row items-center gap-3 flex-1 pr-2">
              ...
              <View className="flex-1">
                <Text className="text-[12px] font-urbanist-medium text-secondary">Location</Text>
                <Text
